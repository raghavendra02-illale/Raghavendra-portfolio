...
An interactive, dark-futuristic Developer Workstation OS and engineering portfolio showcasing the work of **Raghavendra Illale**, Applied AI & Backend Systems Engineer at **L&T Technology Services** (Client: **ADE - DRDO**, Aeronautical Development Establishment).
...
- **Current Organization:** L&T Technology Services (Client: ADE-DRDO)
...
- **Direct Coordinates:**
  ...
  - 🌐 GitHub: [github.com/raghavendraillale](https://github.com/raghavendraillale)
...
- **Quick Links:** One-click copy for email and phone numbers, direct access to coding profiles (LeetCode, GeeksforGeeks, Code360, HackerRank).

### 2. Space `02 // ADE-DRDO.c` (Defense Aerospace Tooling)
...
- **Filterable Showcase:** Filter by `All (6)`, `GenAI & Agents (3)`, `Aerospace (ADE-DRDO)`, and `Data & Cloud`.
  - *Autonomous Multi-Agent Financial Research System* (LangGraph / CrewAI)
  - *Conversational Low-Latency Voice AI Assistant* with live frequency visualizer animation
  - *Enterprise Hybrid RAG Knowledge Engine* (ChromaDB / LangChain)
  - *Deterministic Configuration & Flight Telemetry Engine* (Standard C99)
  - *Automated Non-Regression Testing (NRT) Suite* (Python / Pandera / PyTest)
  - *High-Throughput Distributed Telemetry Ingestion Pipeline* (FastAPI / Redis / Kafka)
...
1. Clone or extract the project repository:
   ```bash
   git clone https://github.com/raghavendraillale/workstation-os.git
   cd workstation-os
   ```
...
│   │   ├── DefenseSection.tsx      # ADE-DRDO C/Python telemetry verification engine
