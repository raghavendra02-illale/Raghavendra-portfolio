      ...
      <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
        <div className="flex flex-col gap-3 max-w-2xl">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full bg-[#1b273e] text-[#8b5cf6] font-mono text-[11px] border border-[#1e293b]">
              AUTONOMOUS RAG
            </span>
          </div>
        ...
        <div className="w-full lg:w-80 p-4 rounded-xl bg-[#05080e] border border-[#1e293b] flex flex-col gap-2.5 holo-card">
          ...
          <div className="grid grid-cols-2 gap-2 pt-1 font-mono text-xs">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded bg-[#141d2f] hover:bg-[#10b981] hover:text-[#090d16] text-[#f1f5f9] text-center active:scale-95 transition-all flex items-center justify-center gap-1.5 font-semibold cursor-pointer border border-[#1e293b]/40"
